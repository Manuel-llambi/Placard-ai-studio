...
export const Step3Result: React.FC<Step3ResultProps> = ({
  ...
  const handleShare = async () => {
    try {
      // Share.share es la API nativa de RN (hoja de compartir del sistema en iOS/Android).
      // En web, react-native-web la mapea al Web Share API cuando existe.
      await Share.share({
        title: 'Mi primer look en Placard VTON',
        message: `Mirá cómo me queda el ${result.garment.name} en mi probador virtual Placard.`,
      });
    } catch {
